...
protected:
	...
	void UpdateControlStatus(BOOL bConntected);
	void SetUnplugged();
	...
	afx_msg void OnBnClickedConnectLocal();
	afx_msg void OnBnClickedConnectCloud();
	//}}AFX_MSG
